...
mkdir fig/200m_30000iter_scenario2
...
echo "200m"
cp config/deployment/train_K20_N100_M3_shadow10_episode3-10000_travelIND_fd10_r200_s2.json config/deployment/train_K20_N100_M3_shadow10_episode3-10000_travelIND_fd10.json
...
cd fig
./temscript_30000.sh 200m_30000iter_scenario2
cd ..
