...
mkdir fig/180m_30000iter_scenario2


###### 50m

cp uav_location_scenario2_180m.txt uav_location.txt

echo "Copying the net deployment"
echo "140m"
cp config/deployment/train_K20_N100_M3_shadow10_episode3-10000_travelIND_fd10_r180_s2.json config/deployment/train_K20_N100_M3_shadow10_episode3-10000_travelIND_fd10.json
...
cd fig
./temscript_30000.sh 180m_30000iter_scenario2
cd ..
