...
mkdir fig/300m_30000iter_scenario2_v2


###### 300m

cp uav_location_scenario2_300m.txt uav_location.txt

echo "Copying the net deployment"
echo "300m"
cp config/deployment/train_K20_N100_M3_shadow10_episode3-10000_travelIND_fd10_r300_s2_v2.json config/deployment/train_K20_N100_M3_shadow10_episode3-10000_travelIND_fd10.json
...
cd fig
./temscript_30000.sh 300m_30000iter_scenario2_v2
cd ..
