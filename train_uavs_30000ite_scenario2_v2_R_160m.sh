...
mkdir fig/160m_30000iter_scenario2_v2


###### 50m

cp uav_location_scenario2_160m.txt uav_location.txt

echo "Copying the net deployment"
echo "140m"
cp config/deployment/train_K20_N100_M3_shadow10_episode3-10000_travelIND_fd10_r160_s2_v2.json config/deployment/train_K20_N100_M3_shadow10_episode3-10000_travelIND_fd10.json
...
cd fig
./temscript_30000.sh 160m_30000iter_scenario2_v2
cd ..
